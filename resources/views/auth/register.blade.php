<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <!-- CPF -->
        <div class="mt-4">
            <x-input-label for="user_document" :value="__('CPF')" />
            <x-text-input id="user_document" class="block mt-1 w-full" type="number" name="user_document" :value="old('user_document')" required  />
